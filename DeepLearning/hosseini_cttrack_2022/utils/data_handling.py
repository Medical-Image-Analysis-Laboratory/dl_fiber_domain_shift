...
class DataHandler(object):
    ...
    def normalize_dwi(weights, b0):
        ...
        weights_normed[np.logical_not(np.isfinite(weights_normed))] = 0.0

        return weights_normed

    def get_spherical_harmonics_coefficients(
        self, dwi_weights, bvals, bvecs, sh_order=8, smooth=0.006
    ):
